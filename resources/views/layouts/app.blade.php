...
<body class="{{ request()->routeIs('home') ? 'is-home' : '' }}" style="background-color: #FFE1AF; color: #957C62;">
    ...
    <main class="py-8 md:py-12">
        ...
        <div class="container-responsive">
            ...
            @if (session('success'))
                <div class="mb-6 animate-slide-in p-6 rounded-2xl border-2" style="background-color: #1F4D00; border-color: #0D2600;">
                    <div class="flex items-center">
                        <svg class="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 20 20" style="color: #FFFFFF;">
